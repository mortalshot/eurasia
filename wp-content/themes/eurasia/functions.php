...
?>
	<div class="woocommerce-variation-add-to-cart variations_button">
		<button type="submit" class="custom_add_to_cart single_add_to_cart_button button ajax_add_to_cart"><?php echo esc_html($product->single_add_to_cart_text()); ?></button>
