...
function EWD_UWCF_Update_Options() {
    ...
    if (isset($_POST['sizes_used_for_variations'])) {
    	$Sizes_Variation = get_option("EWD_UWCF_Sizes_Used_For_Variations");
    	$Update_Sizes_Variation = ($Sizes_Variation == $_POST['sizes_used_for_variations'] ? false : true);
    }
    else {$Update_Sizes_Variation = false;}

	if (isset($_POST['enable_table_format'])) {update_option('EWD_UWCF_Table_Format', $_POST['enable_table_format']);}
	if (isset($_POST['allow_sorting'])) {update_option('EWD_UWCF_Allow_Sorting', $_POST['allow_sorting']);}
	if (isset($_POST['fields_array'])) {update_option('EWD_UWCF_Fields_Array', explode(",", $_POST['fields_array']));}

	if (isset($_POST['name_displayed'])) {update_option('EWD_UWCF_Product_Title_Displayed', $_POST['name_displayed']);}
	if (isset($_POST['image_displayed'])) {update_option('EWD_UWCF_Product_Image_Displayed', $_POST['image_displayed']);}
	if (isset($_POST['price_displayed'])) {update_option('EWD_UWCF_Product_Price_Displayed', $_POST['price_displayed']);}
	if (isset($_POST['rating_displayed'])) {update_option('EWD_UWCF_Product_Rating_Displayed', $_POST['rating_displayed']);}
	if (isset($_POST['add_to_cart_displayed'])) {update_option('EWD_UWCF_Product_Add_To_Cart_Displayed', $_POST['add_to_cart_displayed']);}

	if (isset($_POST['price_enable'])) {update_option('EWD_UWCF_Product_Price_Enable', $_POST['price_enable']);}
	if (isset($_POST['price_display'])) {update_option('EWD_UWCF_Product_Price_Display', $_POST['price_display']);}
	...
	if (isset($_POST['enable_text_search'])) {update_option('EWD_UWCF_Enable_Text_Search', $_POST['enable_text_search']);}
	...
	foreach ($attribute_taxonomies as $attribute_taxonomy) {
		...
		if (isset($_POST[$attribute_taxonomy->attribute_name . '_displayed'])) {update_option("EWD_UWCF_" . $attribute_taxonomy->attribute_name . "_Displayed", $_POST[$attribute_taxonomy->attribute_name . '_displayed']);}
