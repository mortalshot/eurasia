...
include "Functions/EWD_UWCF_Version_Reversion.php";
include "Functions/EWD_UWCF_WC_Filters_Actions.php";
include "Functions/EWD_UWCF_WC_Table_Format.php";
...
function EWD_UWCF_Option_Data_Options() {
	...
	if (get_option("EWD_UWCF_Table_Format") == "") {update_option("EWD_UWCF_Table_Format", "No");}
	if (get_option("EWD_UWCF_Allow_Sorting") == "") {update_option("EWD_UWCF_Allow_Sorting", "No");}
	...
	if (get_option("EWD_UWCF_Product_Price_Enable") == "") {update_option("EWD_UWCF_Product_Price_Enable", 'No');}
	if (get_option("EWD_UWCF_Product_Price_Display") == "") {update_option("EWD_UWCF_Product_Price_Display", 'Text');}
